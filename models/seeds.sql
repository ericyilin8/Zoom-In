use zoom_In;
-- add data into the photo_catagory table --
INSERT INTO photo_catagories (catagory, createdAt, updatedAt) values ('Nature', NOW(), NOW());
INSERT INTO photo_catagories (catagory, createdAt, updatedAt) values ('Studio', NOW(), NOW());
INSERT INTO photo_catagories (catagory, createdAt, updatedAt) values ('Urban', NOW(), NOW());
INSERT INTO photo_catagories (catagory, createdAt, updatedAt) values ('Sports', NOW(), NOW());
...
-- add data into the catagory_junction table --
INSERT INTO catagory_junctions (userId, catId, createdAt, updatedAt) values (1, 1, NOW(), NOW());
INSERT INTO catagory_junctions (userId, catId, createdAt, updatedAt) values (1, 2, NOW(), NOW());
INSERT INTO catagory_junctions (userId, catId, createdAt, updatedAt) values (1, 3, NOW(), NOW());
INSERT INTO catagory_junctions (userId, catId, createdAt, updatedAt) values (2, 1, NOW(), NOW());
INSERT INTO catagory_junctions (userId, catId, createdAt, updatedAt) values (3, 1, NOW(), NOW());